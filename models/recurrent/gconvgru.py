...
class G_Conv_GRU(nn.Module):

    """
    Improved GConvGRU architecture.
    ...
    def __init__(self,in_ch,hidden,horizon,dropout,K=2):
        ...
        self.rnn=GConvGRU(hidden,hidden,K)
    ...
    def forward(self,x_seq,edge_index,edge_weight):
        ...
        for t in range(T):
            ...
            h=self.rnn(x_t,ei,ew,h,lambda_max=None)
